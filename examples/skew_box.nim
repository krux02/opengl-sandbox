...
proc recomputeBoxPositions(boxPositions: var seq[Vec4f], boxPositionsBuffer: var ArrayBuffer[Vec4f], time: float32): void =
...
proc main*(window: Window): void =
  ...
  while runGame:
    ...
    recomputeBoxPositions(boxPositions, boxPositionsBuffer, time)
